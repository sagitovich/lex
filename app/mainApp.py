...
class TES_UserMain(QWidget):
    ...
    def __init__(self, parent_window):
        ...
        self.label = QLabel(self.scrollArea)  # Создаем QLabel
        self.label.setAlignment(Qt.AlignTop)  # Выравниваем текст по верхнему краю
        self.scrollArea.setWidget(self.label)  # Добавляем QLabel в QScrollArea
    ...
    def click(self):
        ...
        try:
            ...
            self.label.setText(text)  # Устанавливаем текст для QLabel, а не для QScrollArea

        except (KeyError, IndexError, TypeError):
            self.label.setText('')  # очищаем scrollArea
